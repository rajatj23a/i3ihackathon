...
city_states.India = "Delhi|Andaman/Nicobar Islands|Andhra Pradesh|Arunachal Pradesh|Assam|Bihar|Chandigarh|Chhattisgarh|Dadra/Nagar Haveli|Daman/Diu|Goa|Gujarat|Haryana|Himachal Pradesh|Jammu/Kashmir|Jharkhand|Karnataka|Kerala|Lakshadweep|Madhya Pradesh|Maharashtra|Manipur|Meghalaya|Mizoram|Nagaland|Orissa|Pondicherry|Punjab|Rajasthan|Sikkim|Tamil Nadu|Tripura|Uttaranchal|Uttar Pradesh|West Bengal";  
...
var city_person = Object();
city_person["Delhi"] = "Kavita Tyagi|Rahul Sharma";
city_person.Gao = "Siri|Anushka|Vidya";
...
function set_city_person(b, a) {
    ...
    if (city_person[e]) {
        a.disabled = false;
        a.options[0] = new Option("Select Insured Applicant", "");
        d = city_person[e].split("|");
        for (var c = 0; c < d.length; c++) {
            a.options[c + 1] = new Option(d[c], d[c])
        }
    }
...
function print_city_state(b, a)   
{
    ...
    if (c && city_person[d].indexOf(c) != -1)
    {  
...
function print_city_state1(b, a) {
